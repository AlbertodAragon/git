...
{     
    ...
    if ($('.interestedhidden').prop("checked") != true){
     ...
     /*   alert(postData);*/
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == 'OK') {
                    $('#outcomemsg').html('');
                    $('#contactform').html('<div id="thankyoumsg"><h1>Thank you<br/>' + thename + '</h1><br/>Our Sales team will be in touch soon to arrange your viewing.<br/><img src="/gfx/James-G-signature.jpg" style="text-align:center;height:100px;width:auto;margin:10px auto;"><hr><p>James Guilfoyle<br/>Sales Manager<br/><a id="mailform" href="mailto:james.guilfoyle@almacantar.com">james.guilfoyle@almacantar.com</a><br/><a id="phoneform" href="tel:004402075352900">+44 (0) 20 7535 2900</a></div>');
                }
                else {
                    $("#submitformhome").click(function (event) {
                        event.preventDefault();
